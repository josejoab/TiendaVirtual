                    ...
                    <div class="col-lg-6">
                        ...
                        <div class="product-thumbs">
                            <div class="product-thumbs-track ps-slider owl-carousel">
                                <div class="pt active" data-imgbigurl="{{ asset('/img/designs/'.$data["design"]->image ) }}"><img src="{{ asset('/img/designs/'.$data["design"]->image ) }}" alt=""></div>
                                <div class="pt" data-imgbigurl="{{ asset('/img/designs/thumbs/'.$data["design"]->image ) }}"><img src="{{ asset('/img/designs/thumbs/'.$data["design"]->image ) }}" alt=""></div>
                                <div class="pt" data-imgbigurl="{{ asset('/img/designs/thumbs/'.$data["design"]->image ) }}"><img src="{{ asset('/img/designs/thumbs/'.$data["design"]->image ) }}" alt=""></div>
                                <div class="pt" data-imgbigurl="{{ asset('/img/designs/thumbs/'.$data["design"]->image ) }}"><img src="{{ asset('/img/designs/thumbs/'.$data["design"]->image ) }}" alt=""></div>
                            </div>
                        </div>
